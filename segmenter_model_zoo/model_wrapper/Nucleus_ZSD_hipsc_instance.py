...
min_size_dna = 100000 #10000
max_size_dna = 1800000 #500000

def SegModule(input_img, models, return_prediction=False):
    ...
    writer = omeTifWriter.OmeTifWriter('mask.tiff')
    writer.save(bw1.astype(np.float32))
