...
def SegModule(
    ...
    # model 4: cell boundary from BF to further prune the mask
    cellmask_pred = model_list[4].apply_on_single_zstack(
        input_img=img[2, :, :, :], use_tta=False
    )
    cellmask_bw = cellmask_pred > mem_bf_cut
